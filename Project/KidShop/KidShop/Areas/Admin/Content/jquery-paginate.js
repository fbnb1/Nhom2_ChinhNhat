            ...
            $.ajax({
                ...
                if (data.Data.length > 0) {
                    ...
                    $.each(data.Data, function (index, value) {
                        ...
                        str += '<td class="a-center "><input type="checkbox" class="flat" name="table_records"></td>';
                        str += '<td>' + value.ProductName + '</td>';
                        str += '<td>' + value.ProductId + '</td>';
                        str += '<td>' + value.CategoryName + '</td>';
                        str += '<td>' + value.Price + '</td>';
                        str += '<td>' + value.Qty + '</td>';
                        str += '<td><img src="/Areas/Admin/Content/Images/Product/' + value.Image + '" id="Image" class="img-rounded" style="margin-left: 20px; width: 20px; height: 20px;" /></td>';
                        str += '<td><input type = "checkbox" class="flat" disabled = "" /></td>';
                        str += '<td class=" last">';
